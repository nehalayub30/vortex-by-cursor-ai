<?php
/**
 * Artist Subscription Plans Template
 *
...
$plans = $subscriptions->artist_plans;
?>

<div class="vortex-subscription-plans vortex-artist-plans">
    <h2><?php esc_html_e('Artist Subscription Plans', 'vortex'); ?></h2>
